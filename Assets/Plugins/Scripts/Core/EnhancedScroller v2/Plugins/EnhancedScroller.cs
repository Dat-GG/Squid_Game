...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        /// <param name="isForceJump">Minh's addtion --> force scroller to jump even meet "ignore the jump" condition of Enhanced Scroller</param>
        ...
        {
            // ignore check "ignore jump condition" of Scroller Enhanced --> Fix bug can not jump when scroller have only 2 elements.
            if (isForceJump is false)
            {
        ...
        /// </summary>
        /// <param name="isForceSnap">Minh's addtion --> force scroller to snap even meet "ignore jump" condition of Enhanced Scroller</param>
        public void Snap(bool isForceSnap = false)
        {
            ...
            JumpToDataIndex(_snapDataIndex, snapJumpToOffset, snapCellCenterOffset, snapUseCellSpacing, snapTweenType, snapTweenTime, SnapJumpComplete, LoopJumpDirectionEnum.Closest, isForceSnap);
        }
