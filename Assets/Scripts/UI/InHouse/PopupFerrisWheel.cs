...
namespace UI.InHouse
{
    ...
    public class PopupFerrisWheel : PopupBase
    {
        ...
        private void OnClickBuyWithGoldBtn()
        {
            ...
            { 
                ...
                _housePopup.FerrisWheel.SetActive(true);
                _housePopup.DecorFerrisWheelBtn.gameObject.SetActive(false);
                DataAccountPlayer.PlayerSettings.SetInHouse(_housePopup.FerrisWheel.name);
                Close();
            }
            else
            {
